...
# Members
# -------------------
def add_member(name, age, gender, joined_date, phone=None, email=None,username=None,password=None):
    with connect(commit=True) as cursor:
        cursor.execute(
            "INSERT INTO members (name, age, gender, joined_date, phone, email,username,password) VALUES (%s, %s, %s, %s, %s, %s,%s,%s)",
            (name, age, gender, joined_date, phone, email,username,password),
        )
...
def update_member(member_id, name=None, age=None, gender=None, joined_date=None, phone=None, email=None,username=None,password=None,role='member'):
    fields = []
    vals = []
    if name is not None:
